...
{#if mockupPreviewOpen}
	<div class="fixed inset-0 z-50 flex items-center justify-center px-6 py-10">
		...
		<div class="relative w-full max-w-md rounded-[28px] border border-gray-100 bg-white p-8 text-left shadow-[0_25px_70px_-30px_rgba(15,23,42,0.45)]">
			...
			<h3 class="mt-6 text-2xl font-semibold text-gray-900">Mockup Preview</h3>
			<p class="mt-2 text-sm text-gray-500">
			...
			<div class="mt-8 flex justify-end">
				<button
					type="button"
					class="rounded-2xl bg-[#FF6F61] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#ff846f]"
					onclick={closeMockupPreview}
				>
					Got it
				</button>
