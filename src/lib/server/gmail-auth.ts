...
import { firestore, gmailConnectionsCollectionRef } from './firestore';
import { serverTimestamp } from './firestore';
import { env } from '$env/dynamic/private';
import { createLogger } from '$lib/server/logger';

const GMAIL_CLIENT_ID = env.GMAIL_OAUTH_CLIENT_ID;
const GMAIL_CLIENT_SECRET = env.GMAIL_OAUTH_CLIENT_SECRET;
const GMAIL_REDIRECT_URI = env.GMAIL_OAUTH_REDIRECT_URI;
const ENCRYPTION_KEY_B64 = env.GMAIL_TOKEN_ENCRYPTION_KEY;
...
export async function storeGmailTokens(
	uid: string,
	tokens: GmailTokens,
	options?: { connectionId?: string | null; makePrimary?: boolean }
