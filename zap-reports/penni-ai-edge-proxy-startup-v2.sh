...
server {
	...
	more_set_headers 'Content-Security-Policy: default-src \x27self\x27; base-uri \x27self\x27; frame-ancestors \x27none\x27; object-src \x27none\x27; form-action \x27self\x27; img-src \x27self\x27 data: https:; script-src \x27self\x27; style-src \x27self\x27 \x27unsafe-inline\x27; connect-src \x27self\x27 https: wss:; font-src \x27self\x27 data: https:; upgrade-insecure-requests';
